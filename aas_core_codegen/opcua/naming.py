"""
Generate identifiers internal to an OPC UA node set.
...
these identifiers are used only for the OPC UA node set.
"""
from aas_core_codegen.common import Identifier

# TODO: fix documentations, names etc. -- this has been just copy/pasted from xsd!
